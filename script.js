...
async function sendToExcel(exportData) {
  ...
  try {
    ...
    if (result.status !== 'ok') throw new Error(result.message || 'respuesta inesperada del servidor');

    showSubmitStatus('success', '✅ Tus respuestas se guardaron automáticamente.');
  } catch (e) {
